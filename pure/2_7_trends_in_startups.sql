...
-- Insert test data into the startup's table
INSERT INTO startups (name, category, valuation, raised, stage, founded, location, employees)
VALUES ('TechNova', 'Tech', 1000000, 500000, 'Seed', '2020-01-15', 'San Francisco', 50),
...
-- Adjusted queries for PostgresSQL
...
FROM startups
WHERE stage = 'Seed'
  AND raised = (SELECT MAX(raised) FROM startups WHERE stage = 'Seed');

-- 6. Name and the earliest founding date
SELECT name, founded
FROM startups
