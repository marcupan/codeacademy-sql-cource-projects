...
VALUES (1, 1, 15.50, '2024-11-14 10:30:00'),
       (2, 2, 22.00, '2024-11-13 14:45:00'),
       (3, 3, 18.75, '2024-11-12 08:20:00');

-- Insert test data into the rider's table
INSERT INTO riders (name, total_trips)
VALUES ('Alice', 200),
       ('Bob', 150),
       ('Charlie', 500);

-- Insert test data into the car's table
INSERT INTO cars (model, status, trips_completed)
VALUES ('Toyota Prius', 'active', 1000),
...
-- 2. Retrieve the first 2 rows from the rider's table
SELECT *
FROM riders
LIMIT 2;

-- 3. Retrieve the first 2 rows from the car's table
SELECT *
FROM cars
LIMIT 2;
