...
VALUES ('GPT-4', 'Language model', '2023-03-15', 175000000000, 1),
...
VALUES (1, 1), -- OpenAI -> Language understanding
...
-- Task 2: Count the number of AI systems created by each organization
...
-- Task 3: Refine the query to filter by AI System Type
SELECT o.name          AS organization_name,
...
-- Add an organization type to the query
SELECT o.name          AS organization_name,
...
-- Task 4: Investigate AI Development Over Time
...
-- Task 5: Find the Top 5 AI Problems Organizations Focus On
