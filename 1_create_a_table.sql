...
-- Insert a single row into the friends table
INSERT INTO friends (id, name, birthday) VALUES
    (1, 'Ororo Munroe', '1940-05-30');

-- Select all rows from the friends table
SELECT * FROM friends;

-- Insert multiple rows into the friends table
INSERT INTO friends (id, name, birthday) VALUES
    (2, 'John', '1972-04-10'),
    (3, 'Otto', '1958-06-03');
...
-- Select all rows from the friends table to check the changes
SELECT * FROM friends;
...
-- Select all rows from the friends table to confirm updates
SELECT * FROM friends;

-- Delete the friend with id 1
DELETE FROM friends WHERE id = 1;

-- Select all remaining rows from the friends table
SELECT * FROM friends;
